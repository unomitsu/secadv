        ...
        db.serialize(() => {
            ...
            db.get('SELECT * FROM scenario_element', function (err, row) {
                ...
                // データが存在しない場合、初期のシナリオを挿入
                    ...
                    stmt2.run([4, '@teacher@「じゃあ情報環境実験２のLegoの説明を始めます。」', 1]);
                    stmt2.run([4, '@teacher@「じゃあ情報環境実験２のLegoの説明を始めます。始めます。」', 2]);
                    stmt2.run([4, '@teacher@「じゃあ情報環境実験２のLegoの説明を始めます。始めます。始めます。」', 3]);
